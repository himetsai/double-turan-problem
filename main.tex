...
Thereafter, we show that if there is an extremal $F$-free graph with maximum degree at most $n^{1/2}/m^2$, then the above bound is tight. 
  ...
  Hence,
  \[
    \sum_{\substack{S \subseteq [m] \\ |S| \geq 2}} (|S| - 2 + 1)|E_S| = \sum_{\substack{S \subseteq [m], \\ |S| = 2}} \sum_{T \subseteq S} \frac{(|T| - 1)|E_T|}{\binom{|T|}{2}} \leq \sum_{\substack{S \subseteq [m], \\ |S| = 2}} \sum_{T \subseteq S} |E_T| \leq \binom{m}{2}\text{ex}(n, F),
  \]
