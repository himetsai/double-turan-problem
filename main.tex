...
\textcolor{red}{TODO: add the ``suffice to show for $m = 2$'' lemma, the condition for all $G_i$'s to be extremal graphs for $F$ for all $m$, and generalize to hypergraph.}
